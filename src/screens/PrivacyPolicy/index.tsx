    ...
    <DefaultTemplate backIcon bgColor="white">
      <ScrollView style={styles.scrollView}>
        ...
        <Text className="font-poppinsMedium text-base text-textPrimary py-3">
          ...
          Application refers to Word Race, the software program provided by the
          Company. Company (referred to as either "the Company", "We", "Us" or
          "Our" in this Agreement) refers to Word Race. Country refers to:
          Turkey Device means any device that can access the Service such as a
          ...
          Service refers to the Application. Service Provider means any natural
        ...
        <Text className="font-poppinsMedium text-base text-textPrimary py-3">
          ...
          investigate possible wrongdoing in connection with the Service Protect
          the personal safety of Users of the Service or the public Protect
