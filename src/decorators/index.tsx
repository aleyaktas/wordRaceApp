...
export const BufferView: any = (storyFn: any) => (
  <View style={{ flex: 1, height: '100%', paddingVertical: 40, paddingHorizontal: 20, backgroundColor: '#fff', overflow: 'visible' }}>{storyFn()}</View>
);

export const GrayView: any = (storyFn: any) => <View style={{ flex: 1, padding: 25, backgroundColor: '#F8F8F8' }}>{storyFn()}</View>;
